...
try {
		System.out.println("Программа выводить в консольное окно прямоугольник, размеры сторон которого, ширина: 23 колонки, высота: 11 строк  ");
		...
		for (i = 1 ; i <= figure; i++) { 
			System.out.print("№ строки: " + i + " ");
		    z = 0;
		    for (j = -12; j < figure; j++){ System.out.print("*"); z = z + 1; }
