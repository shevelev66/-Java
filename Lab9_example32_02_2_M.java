...
public class example32_02_2_M { //РЕАЛИЗАЦИЯ С МЕТОДАМИ
	public static int [] [] RandArr(int [] [] array) {//метод случайного заполнения массива (матрицы)
		//т.к. массив заполняется без участия пользователя, то ошибки исключены :)
	...
	public static void Ncol(int [] [] array) throws InputMismatchException, ArrayIndexOutOfBoundsException { //метод вывода n-го столбца
		...
		public static void main(String[] args) {
			try {		
				...
				array=RandArr(array); // метод заполнения случайными данными
				System.out.println("---------------------------------------------------------------");
				Ncol(array); //метод вывода n-го столбца
		    }
